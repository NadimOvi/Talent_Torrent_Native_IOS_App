...
protocol ClientAwardedJobViewDelegate {
    func awardedJobInfo(totalNumber: String)
}

class ClientAwardedJobView: UIView {

    let identifire = "ClientAwardedJobView"
    var delegate: ClientAwardedJobViewDelegate?
    ...
    override func awakeFromNib() {
        ...
        print("------------")
        trailingURL = "client/jobs/awarded"
...
extension ClientAwardedJobView: UICollectionViewDataSource, UICollectionViewDelegate {
...
extension ClientAwardedJobView: UICollectionViewDelegateFlowLayout {
