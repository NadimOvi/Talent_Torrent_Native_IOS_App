...
protocol ClientOngoingJobViewDelegate {
    func awardedJobInfo(totalNumber: String)
}

class ClientOngoingJobView: UIView {

    let identifire = "ClientOngoingJobView"
    var delegate: ClientOngoingJobViewDelegate?
...
//        EmptyJobShowLabel.text = "No Job Found"
        ...
        print("------------")
        trailingURL = "client/jobs/ongoing"
...
extension ClientOngoingJobView: UICollectionViewDataSource, UICollectionViewDelegate {
...
extension ClientOngoingJobView: UICollectionViewDelegateFlowLayout {
