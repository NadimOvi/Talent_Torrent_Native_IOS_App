...
protocol ClientCompletedJobViewDelegate {
    func awardedJobInfo(totalNumber: String)
}

class ClientCompletedJobView: UIView {

    let identifire = "ClientCompletedJobView"
    var delegate: ClientCompletedJobViewDelegate?
    ...
    override func awakeFromNib() {
        ...
        print("------------")
        trailingURL = "client/jobs/completed"
...
extension ClientCompletedJobView: UICollectionViewDataSource, UICollectionViewDelegate {
...
extension ClientCompletedJobView: UICollectionViewDelegateFlowLayout {
