...
protocol ExpertAwardedJobViewDelegate {
    func expertAwardedJobInfo(totalNumber: String)
}

class ExpertAwardedJobView: UIView {

    let identifire = "ExpertAwardedJobView"
    var delegate: ExpertAwardedJobViewDelegate?
    ...
    override func awakeFromNib() {
        ...
        trailingURL = "expert/jobs/awarded"
        ...
        apiRequest.sendAPIRequestBackData(trailingURL: trailingURL, method: .get, parameters: nil, headers: headers) { json, error in
            ...
            self.delegate?.expertAwardedJobInfo(totalNumber: totalJob)
        }
...
extension ExpertAwardedJobView: UICollectionViewDataSource, UICollectionViewDelegate {
...
extension ExpertAwardedJobView: UICollectionViewDelegateFlowLayout {
