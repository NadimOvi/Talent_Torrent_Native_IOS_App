...
protocol ExpertCompleteJobViewDelegate {
    func expertCompleteJobInfo(totalNumber: String)
}

class ExpertCompleteJobView: UIView {

    let identifire = "ExpertCompleteJobView"
    var delegate: ExpertCompleteJobViewDelegate?
    ...
    override func awakeFromNib() {
        ...
        trailingURL = "expert/jobs/completed"
        ...
        apiRequest.sendAPIRequestBackData(trailingURL: trailingURL, method: .get, parameters: nil, headers: headers) { json, error in
            ...
            self.delegate?.expertCompleteJobInfo(totalNumber: totalJob)
        }
...
extension ExpertCompleteJobView: UICollectionViewDataSource, UICollectionViewDelegate {
...
extension ExpertCompleteJobView: UICollectionViewDelegateFlowLayout {
