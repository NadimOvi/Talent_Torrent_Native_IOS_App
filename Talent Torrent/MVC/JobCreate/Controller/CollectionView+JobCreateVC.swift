//
//  CollectionView+JobCreateVC.swift
//  Talent Torrent
//
...
extension JobCreateVC: UICollectionViewDelegate, UICollectionViewDataSource {
...
extension JobCreateVC: UICollectionViewDelegateFlowLayout {
