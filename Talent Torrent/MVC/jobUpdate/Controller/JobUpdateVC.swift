...
class JobUpdateVC: UIViewController {
    ...
    @IBAction func createJobButtonAction(_ sender: UIButton) {
        ...
        trailingURL = "job/update/\(storeDetailsInfo[0].jobUUID)"
        let userId: String = defaults.string(forKey: "userID") ?? ""
...
//
//
//    var trailing_url = "job/categories"
//    var apiRequest = APIRequest()
//
//    override func viewDidLoad() {
//        super.viewDidLoad()
...
//        activityIndicator.isHidden = true
//        apiRequest.delegate = self
//        apiRequest.getPostToAPIRequest(trailingURL: trailing_url, method: .get, parameters: nil, headers: nil)
//
//
//    }
//
...
//        else { return }
////        FIXME:- set uuid last part of url
//        trailing_url = "job/update/\(storeDetailsInfo[0].jobUUID)"
//        let userId: String = defaults.string(forKey: "userID") ?? ""
//
//
//        let headers: HTTPHeaders = [
